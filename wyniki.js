...
(async () => {
  ...
  for (let pageNumber = 1; pageNumber < 7; pageNumber++) {
    let nextPage = `https://www.concordiaubezpieczenia.pl/biuro-prasowe/wyniki-finansowe,219.html?pg=${pageNumber}&`;
    ...
    const articles = await page.evaluate(async () => {
      ...
      for (const articleSingle of article) {
        articleSingle.querySelector(".rozbutton").click();
        data = {};
        console.log(articleSingle);
        data.title = articleSingle.querySelector("h2").innerText;
        data.month = articleSingle.querySelector(".data").innerText.slice(5, 7);
        data.day = articleSingle.querySelector(".data").innerText.slice(8, 10);
        data.year = articleSingle.querySelector(".data").innerText.slice(0, 4);
  ...
  async function createPost(data) {
    ...
    await page.waitForSelector("#editor-post-taxonomies-hierarchical-term-11");
    await page.click("#editor-post-taxonomies-hierarchical-term-11");
